...
class StoryTasks:
    def __init__(self, image_path: str):
        # Caption task with image path manually injected
        ...
        # Search task gets context (caption output)
        ...
        # Story task gets context (search output)
        self.lore_task = Task(
    ...
    context=[self.caption_task]
        ...
        # Polish task gets context (raw story)
